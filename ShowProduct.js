    ...
    return(
            <View style={styles.container}>
				...
				<View style={{padding:4}}>
					<Text>Department: {Props.item.Department}</Text>
				</View>
				<View style={{padding:4}}>
